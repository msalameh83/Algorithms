...
Examples:
Given 1 egg adn 10 floors, we need 10 attemps in the worst case. I can start with the first floor,
...
def edp(eggs, floors):
    ...
    for i in chart: print(i)
    # pprint (chart)
    print ('min number of attempts is %i'%chart[eggs][ floors])
